...
# --- Config -----------------------------------------------------------------
# .strip() guards against a stray newline or space sneaking in when a key is
# pasted into a .env file or a hosting secret - that would otherwise make the
# auth header illegal and every request would fail.
...
if __name__ == "__main__":
    sample_report = (
        "The air near my street feels really polluted today, hard to breathe."
    )
